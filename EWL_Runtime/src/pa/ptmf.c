...
/*	ptmf.c	-	pointer-to-member-function support for CodeWarrior
 *C++ for PowerPC
 *
 *	THEORY OF OPERATION
 *
...
#pragma unused(ptmf)
  ...
  smclass GL
      ...
      0 bnelr cr0 bnelr cr6 bnelr cr7
#endif
          li r3,
      0
#if VLE_ON
...
#pragma unused(ptmf2)
  ...
  smclass GL
...
#if VLE_ON
      mr r7,
      r3 li r3, 1 lwz r5, PTMF.this_delta(r7) lwz r6,
      PTMF.this_delta(r4) cmpw cr0, r5,
      r6 bne @ret

          lwz r5,
      PTMF.vtbl_offset(r7) lwz r6, PTMF.vtbl_offset(r4) cmpw cr0, r5,
      r6 bne @ret

          lwz r5,
      PTMF.func_data(r7) lwz r6, PTMF.func_data(r4) cmpw cr0, r5,
      r6 bne @ret
#else
      lwz r5,
      ...
      r6 cmpw cr6, r7, r8 cmpw cr7, r9,
      r10 bnelr cr0 bnelr cr6 bnelr cr7
#endif
          li r3,
      0 @ret :
...
#else
      @1 lwz r0,
      0(r12)stw RTOC, 20(SP)mtctr r0 lwz RTOC,
      4(r12)
#endif
          bctr
}
