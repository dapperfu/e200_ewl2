...
/*
 *	semihosted_console_io.c	-	redirect console I/O through P&E
...
/*
 *	sys_writec		-	write a character to the console via
 *semihosting interface
 *
 */
...
void sys_writec(register void *cp) {
  ...
  __asm volatile(
      ...
      : "=kregs"(value)
      : "i"(Semihosting_Write),
        "kregs"(((semihost_readwrite_parms *)cp)->handle),
        "kregs"(((semihost_readwrite_parms *)cp)->data),
        "kregs"(((semihost_readwrite_parms *)cp)->count)
      : "r0", "r3", "r4", "r5");
#endif
}

/*
 *	sys_write0		-	write a nul-terminated string to the
 *console via semihosting interface
 *
 */
...
void sys_write0(register void *str) {
  ...
  __asm volatile(
      ...
      : "=kregs"(value)
      : "i"(Semihosting_Write),
        "kregs"(((semihost_readwrite_parms *)str)->handle),
        "kregs"(((semihost_readwrite_parms *)str)->data),
        "kregs"(((semihost_readwrite_parms *)str)->count)
      : "r0", "r3", "r4", "r5");
#endif
}

/*
 *	sys_readc		-	read a character from the console via
 *semihosting interface
 *
 */
...
int sys_readc(void) {
  ...
  __asm volatile(
      "se_li 0, %1; se_mr 3, %2; se_mr 4, %3; se_mr 5, %4; se_sc; se_mr %0, 0"
      : "=kregs"(value)
      : "i"(Semihosting_Read), "kregs"(block[0]), "kregs"(block[1]),
        "kregs"(block[2])
      : "r0", "r3", "r4", "r5");
#endif
  return value;
...
/*
 *	sys_exit		-	terminate an application via semihosting
 *interface
 *
 */
...
// r3 = status
#ifdef __VLE__
  __asm volatile("se_li 0, %0; se_mr 3, %1" ::"i"(Semihosting_Exit),
                 "kregs"(status)
                 : "r0", "r3");
...
/*
 *	__read_console	-	read from the console into 'buffer' until
 *end-of-line or 'count' characters have been read
 *
 */
...
/* Use this for simulator output using semihosting interface (sys_write0 did not
   work for gnu qemu simulator */
#else /* __SEMIHOSTING */
