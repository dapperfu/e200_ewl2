...
DESCRIPTION
        ...
        a function call between compressed and uncompressed sections.  The
linker also creates mixed mode branch islands as necessary.  At the end of this
        ...
        have a certain value.  Those registers are reserved for runtime
functions, and the linker will always make calls to those functions safe, so
there is probably few situations where the user may need for a safe island in
...
asm void __safe_switch_to_uncompressed(void) {
  nofralloc
      ...
      addis r11,
      r0, __back_from_uncompressed @ha addi r11, r11,
      __back_from_uncompressed @l mtspr lr, r11 mfmsr r11 mtspr 82,
      r0
      ...
      r12
          ...
          andi.r11,
      r11, MSR_COMP_MASK_REV mtspr SRR1,
      r11
          /* restore r11 and r12 */
          lwz r11,
      8(r1)lwz r12,
...
// The back_from functions do not need to restore the program linkage registers
// so they only come in one version.
...
asm void __back_from_compressed(void) {
  ...
  nofralloc
      ...
      mfmsr r11 mtspr 82,
      r0 andi.r11, r11, MSR_COMP_MASK_REV mtspr SRR1,
      r11
...
asm void __safe_switch_to_compressed(void) {
  nofralloc
      ...
      addis r11,
      r0, __back_from_compressed @ha addi r11, r11,
      __back_from_compressed @l mtspr lr, r11 mfmsr r11 mtspr 82,
      r0
...
asm void __back_from_uncompressed(void) {
  ...
  nofralloc
      ...
      mfmsr r11 mtspr 82,
      r0 ori r11, r11, MSR_COMP_MASK mtspr SRR1,
      r11
