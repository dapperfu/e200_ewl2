...
int sys_open(register void *op)
{
  ...
  __asm volatile ("se_li 0, %1; se_mr 3, %2; se_mr 4, %3; se_mr 5, %4; se_sc; se_mr %0, 0"
      :"=kregs" (value)
      :"i" (Semihosting_Open), "kregs"(((semihost_open_parms *)op)->name), "kregs"(((semihost_open_parms *)op)->semihost_mode), "kregs"(((semihost_open_parms *)op)->name_len)
      :"r0", "r3", "r4", "r5");
#endif
...
int sys_write(register void * wp)
{
  ...
  __asm volatile ("se_li 0, %1; se_mr 3, %2; se_mr 4, %3; se_mr 5, %4; se_sc; se_mr %0, 0"
      :"=kregs" (value)
      :"i" (Semihosting_Write), "kregs"(block->handle), "kregs"(block->data), "kregs"(block->count)
      :"r0", "r3", "r4", "r5");
#endif
...
int sys_read(register void * rp)
{
  ...
  __asm volatile ("se_li 0, %1; se_mr 3, %2; se_mr 4, %3; se_mr 5, %4; se_sc; se_mr %0, 0"
      :"=kregs" (value)
      :"i" (Semihosting_Read), "kregs"(((semihost_readwrite_parms *)rp)->handle), "kregs"(((semihost_readwrite_parms *)rp)->data), "kregs"(((semihost_readwrite_parms *)rp)->count)
      :"r0", "r3", "r4", "r5");
#endif
...
/* 
 * Semihost initialization - stack must be ready to execute C before this is called
 *
 */
