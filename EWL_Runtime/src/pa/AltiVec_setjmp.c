...
//	Altivec_setjmp.c	-	setjmp() and longjmp() routines for
//CodeWarrior C++ for PowerPC
//
//	Copyright © 2002-2006 Freescale Semiconductor, Inc.  All Rights
//Reserved.
...
__setjmpv20:
      ...
      mtvrsave r6
          ...
          mtlr r7        // set at beginning of routine
              mfvscr vr0 // mfvscr is context-synchronizing, so this will take
                         // many cycles
                             la r5,
      ...
      mtvrsave r5 // This is OK because we just saved the non-volatile set and
                  // exercised our right to trash all the volatile vector
                  // registers
...
__longjmpv20:
      ...
      r5
          ...
          lwz r7,
      env->pc // restore PC after our jump through the vectors
          la r5,
      env->vscr lvewx vr0, r0,
      r5 // load 32 bits into lo 32 bits of v0
          mtvscr vr0

              lwz r5,
      env->vrsave // restore vrsave
          mtvrsave r5
