...
FILE
        ...
        $Header: /u/ewl2/EWL_Runtime/src/pa/60x_Excimer_init.c,v 1.1 2012/06/01
16:06:51 b11883 Exp $
...
asm void init_board() {
  nofralloc
      ...
      //	user valid:	yes
      //	sup valid:	yes
      //	WIMG:		write-through, cache-inhibit, memory
      //coherence, guarded 	PP:			R/W
      ...
      r0 isync sync
          ...
          mfmsr r3 ori r3,
      r3,
      (MSR_DR | MSR_IR) isync mtmsr r3 isync sync

          // invalidate and enable the I and D caches

          mfspr r5,
      SPR_HID0 ori r5, r5,
      0xcc00 // enable and invalidate caches
      andi.r6,
      r5,
      0xf3ff // clear the invalidate bits
      mtspr SPR_HID0,
      r5 isync sync mtspr SPR_HID0,
      r6 isync sync
