...
int16_t _EWL_CDECL atosfix16(const char *str) { return (strtosfix16(str, 0L)); }

int32_t _EWL_CDECL atosfix32(const char *str) { return (strtosfix32(str, 0L)); }

int64_t _EWL_CDECL atosfix64(const char *str) { return (strtosfix64(str, 0L)); }
