...
extern void * operator new(_CSTD::size_t,const _STD::nothrow_t&) _EWL_NO_THROW _EWL_WEAK;
extern void operator delete(void *) _EWL_NO_THROW _EWL_WEAK;

extern void * operator new[](_CSTD::size_t) _EWL_THROW_BAD_ALLOC _EWL_WEAK;
extern void * operator new[](_CSTD::size_t,const _STD::nothrow_t&) _EWL_NO_THROW _EWL_WEAK;

extern void operator delete[](void *) _EWL_NO_THROW _EWL_WEAK;
extern void operator delete  (void *, const _STD::nothrow_t&) _EWL_NO_THROW _EWL_WEAK;
extern void operator delete[](void *, const _STD::nothrow_t&) _EWL_NO_THROW _EWL_WEAK;
