...
DESCRIPTION
        ...
        Define __init_hardware and __init_user or use the default stub
functions.
...
SECTION_INIT extern void
__init_registers(void); /* overloadable, set up PPC regs (r1, r2, r13) */
SECTION_INIT extern void
__init_data(void); /* overloadable ROM-to-RAM copy routine */
SECTION_INIT extern void __copy_rom_section(void *dst, const void *src,
                                            unsigned long size);
SECTION_INIT extern void __init_bss_section(void *dst, unsigned long size);
SECTION_INIT WEAK extern void __exception_info_constants(void **info,
                                                         char **R2);
SECTION_INIT WEAK extern int __find_exception_addresses(void *info,
                                                        char *returnaddr,
                                                        void **ex_start,
                                                        void **ex_end);
