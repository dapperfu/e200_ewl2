...
SECTION_INIT extern const char 	_fextabindex_rom[];	/* extabindex source (ROM) address at beginning */
SECTION_INIT extern char 		_fextabindex[];		/* extabindex dest. (RAM) address at beginning */
SECTION_INIT extern char 		_eextabindex[];		/* extabindex dest. (RAM) address after end byte */

/*
 *	Small Data pointers (PPC EABI)
 */

SECTION_INIT extern char			_SDA_BASE_[];	/* Small Data Area (<=8 bytes) base addr */
																/* used for .sdata, .sbss */
SECTION_INIT extern char			_SDA2_BASE_[];	/* Small Data Area 2 (<=8 bytes), base addr */
...
SECTION_INIT extern __rom_copy_info 	_rom_copy_info[];	/* An array of all initialized (data, text or mixed) sections */
...
SECTION_INIT extern __pic_rom_copy_info 	_pic_rom_copy_info[];	/* An array of all initialized (data, text or mixed) sections */
...
SECTION_INIT extern __bss_init_info 	_bss_init_info[];	/* An array of all uninitialized data sections */
...
SECTION_INIT extern __pic_bss_init_info 	_pic_bss_init_info[];	/* An array of all uninitialized data sections */
...
SECTION_INIT extern __eti_init_info 	_eti_init_info[];	/* An array of all uninitialized data sections */
...
SECTION_INIT extern __pic_eti_init_info 	_pic_eti_init_info[];	/* An array of all uninitialized data sections */
...
SECTION_INIT extern const char 	_f_init_rom[];		/* .init source (ROM) address at beginning */
SECTION_INIT extern char 		_f_init[];			/* .init dest. (RAM) address at beginning */
SECTION_INIT extern char 		_e_init[];			/* .init dest. (RAM) address after end byte */

/*
 *	.text -- executable PowerPC EABI code
 */

SECTION_INIT extern const char 	_f_text_rom[];		/* .text source (ROM) address at beginning */
SECTION_INIT extern char 		_f_text[];			/* .text dest. (RAM) address at beginning */
SECTION_INIT extern char 		_e_text[];			/* .text dest. (RAM) address after end byte */

/*
 *	.rodata -- read only data
 */

SECTION_INIT extern const char 	_f_rodata_rom[];	/* .rodata source (ROM) address at beginning */
SECTION_INIT extern char 		_f_rodata[];		/* .rodata dest. (RAM) address at beginning */
SECTION_INIT extern char 		_e_rodata[];		/* .rodata dest. (RAM) address after end byte */

/*
 *	extab -- read only C++ Exception Tables
 */

SECTION_INIT extern const char 	_fextab_rom[];		/* extab source (ROM) address at beginning */
SECTION_INIT extern char 		_fextab[];			/* extab dest. (RAM) address at beginning */
SECTION_INIT extern char 		_eextab[];			/* extab dest. (RAM) address after end byte */

/*
 *	.data -- read/write initialized data
 */

SECTION_INIT extern const char 	_f_data_rom[];		/* .data source (ROM) address at beginning */
SECTION_INIT extern char 		_f_data[];			/* .data dest. (RAM) address at beginning */
SECTION_INIT extern char 		_e_data[];			/* .data dest. (RAM) address after end byte */
...
SECTION_INIT extern const char 	_f_sdata_rom[];		/* .sdata source (ROM) address at beginning */
SECTION_INIT extern char 		_f_sdata[];			/* .sdata dest. (RAM) address at beginning */
SECTION_INIT extern char 		_e_sdata[];			/* .sdata dest. (RAM) address after end byte */
...
SECTION_INIT extern char 		_e_sbss[];			/* .sbss dest. (RAM) address after end byte */

/*
 *	.sdata2 -- PPC embedded small initlialized data
 */

SECTION_INIT extern const char 	_f_sdata2_rom[];	/* .sdata2 source (ROM) address at beginning */
SECTION_INIT extern char 		_f_sdata2[];		/* .sdata2 dest. (RAM) address at beginning */
SECTION_INIT extern char 		_e_sdata2[];		/* .sdata2 dest. (RAM) address after end byte */

/*
 *	.sbss2 -- PPC embedded small initialized (zeroed) data
 */

SECTION_INIT extern char 		_f_sbss2[];			/* .sbss2 dest. (RAM) address at beginning */
SECTION_INIT extern char 		_e_sbss2[];			/* .sbss2 dest. (RAM) address after end byte */

/*
 *	.PPC.EMB.sdata0 -- PPC embedded small data centered around addr. zero
 */

SECTION_INIT extern const char 	_f_PPC_EMB_sdata0_rom[];	/* .PPC.EMB.sdata0 source (ROM) address at beginning */
SECTION_INIT extern char 		_f_PPC_EMB_sdata0[];		/* .PPC.EMB.sdata0 dest. (RAM) address at beginning */
SECTION_INIT extern char 		_e_PPC_EMB_sdata0[];		/* .PPC.EMB.sdata0 dest. (RAM) address after end byte */

/*
 *	.PPC.EMB.sbss0 -- PPC embedded small initlialized (zeroed) data
 */

SECTION_INIT extern char 		_f_PPC_EMB_sbss0[];	/* .PPC.EMB. dest. (RAM) address at beginning */
SECTION_INIT extern char 		_e_PPC_EMB_sbss0[];	/* .PPC.EMB. dest. (RAM) address after end byte */

/*
 *	the following are used by the runtime for EABI PIC/PID
 */

SECTION_INIT extern unsigned int	_f_mwerks_fixup[];			/* .mwerks_fixup dest. (RAM) address at beginning */
SECTION_INIT extern unsigned int _e_mwerks_fixup[];			/* .mwerks_fixup dest. (RAM) address after end byte */

SECTION_INIT extern char 		_ABS_SDA_BASE_[];	/* same as _SDA_BASE_ but is absolute addressed even with SDA PIC/PID */
SECTION_INIT extern char 		_ABS_SDA2_BASE_[];	/* same as _SDA2_BASE_ but is absolute addressed even with SDA PIC/PID */
