...
/*
 *	Prefix file for EWL C++ projects which pulls in the most common
 *precompiled EWL Header files.
 *
 *	This prefix file is ONLY for C++ projects, it will not work for C
 *projects unless C++ is activated.
 */
