...
void _EWL_CDECL __ewl_runtime_constraint_violation_s(
    const char_t *_EWL_RESTRICT msg, void *_EWL_RESTRICT ptr, errno_t error) {
...
constraint_handler_t _EWL_CDECL
...
void _EWL_CDECL abort_handler_s(const char_t *_EWL_RESTRICT msg,
                                void *_EWL_RESTRICT ptr, errno_t error) {
#pragma unused(ptr)
...
void _EWL_CDECL ignore_handler_s(const char_t *_EWL_RESTRICT msg,
                                 void *_EWL_RESTRICT ptr, errno_t error) {
...
void _EWL_CDECL strict_handler_s(const char_t *_EWL_RESTRICT msg,
                                 void *_EWL_RESTRICT ptr, errno_t error) {
#pragma unused(ptr)
  MISRA_QUIET_UNUSED_ARGS()
#if !_EWL_OS_DISK_FILE_SUPPORT
