...
void *(memcpy)(register void *_EWL_RESTRICT dst,
               register const void *_EWL_RESTRICT src, register size_t n) {
  const char_t *p = (char_t *)src;
  char_t *q = (char_t *)dst;

#if !defined(__COLDFIRE__) && !defined(__arm) && !defined(__arm__) &&          \
    !defined(__m56800__) && !defined(__PPC_EABI__) && !defined(__HC12__) &&    \
    !defined(__m56800E__)
