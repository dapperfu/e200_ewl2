 ...
 *called when that signal occurs. An invocation of such a function because of a
 *signal, or (recursively) of any further functions called by that invocation
 *(other than functions in the standard library), is called a signal handler.
 */
