 ...
 *lowercase letter. If the argument is a character for which isupper is true and
 *there are one or more corresponding characters, as specified by the current
 *locale, for which islower is true, the tolower function returns one of the
