...
_EWL_IMP_EXP_C int _EWL_CDECL _fstat(int,
                                     struct _EWL_STAT_TYPE *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _mkdir(const char *, mode_t) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _stat(const char *,
                                    struct _EWL_STAT_TYPE *) _EWL_CANT_THROW;
...
int _EWL_CDECL _stat(const char *path,
                     struct _EWL_STAT_TYPE *buf) _EWL_CANT_THROW {
...
int _EWL_CDECL _fileno(FILE *stream) _EWL_CANT_THROW { return fileno(stream); }
...
_EWL_IMP_EXP_C int _EWL_CDECL _execv(const char *,
                                     const char *const *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _execle(const char *, ...) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _execve(const char *, const char *const *,
                                      const char *const *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _execlp(const char *, ...) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _execvp(const char *,
                                      const char *const *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _execlpe(const char *, ...) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _execvpe(const char *, const char *const *,
                                       const char *const *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _spawnl(int, const char *, ...) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _spawnv(int, const char *,
                                      const char *const *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _spawnle(int, const char *, ...) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _spawnve(int, const char *, const char *const *,
                                       const char *const *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _spawnlp(int, const char *, ...) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _spawnvp(int, const char *,
                                       const char *const *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _spawnlpe(int, const char *, ...) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _spawnvpe(int, const char *, const char *const *,
                                        const char *const *) _EWL_CANT_THROW;
...
_EWL_IMP_EXP_C int _EWL_CDECL _write(int, const void *,
...
int _EWL_CDECL _chdir(const char *path) _EWL_CANT_THROW { return chdir(path); }

int _EWL_CDECL _close(int fildes) _EWL_CANT_THROW { return close(fildes); }
...
int _EWL_CDECL _execv(const char *prog,
                      const char *const *args) _EWL_CANT_THROW {
  return execv(prog, args);
}

int _EWL_CDECL _execve(const char *prog, const char *const *args,
                       const char *const *envp) _EWL_CANT_THROW {
  return execve(prog, args, envp);
}

int _EWL_CDECL _execvp(const char *prog,
                       const char *const *args) _EWL_CANT_THROW {
  return execvp(prog, args);
}

int _EWL_CDECL _execvpe(const char *prog, const char *const *args,
                        const char *const *envp) _EWL_CANT_THROW {
  return execvpe(prog, args, envp);
}

int _EWL_CDECL _spawnv(int mode, const char *prog,
                       const char *const *args) _EWL_CANT_THROW {
  return spawnv(mode, prog, args);
}

int _EWL_CDECL _spawnve(int mode, const char *prog, const char *const *args,
                        const char *const *envp) _EWL_CANT_THROW {
  return spawnve(mode, prog, args, envp);
}

int _EWL_CDECL _spawnvp(int mode, const char *prog,
                        const char *const *args) _EWL_CANT_THROW {
  return spawnvp(mode, prog, args);
}

int _EWL_CDECL _spawnvpe(int mode, const char *prog, const char *const *args,
                         const char *const *envp) _EWL_CANT_THROW {
...
int _EWL_CDECL _dup(int _a) _EWL_CANT_THROW { return dup(_a); }

int _EWL_CDECL _dup2(int _a, int _b) _EWL_CANT_THROW { return dup2(_a, _b); }
...
char *_EWL_CDECL _getlogin(void) _EWL_CANT_THROW { return getlogin(); }

int _EWL_CDECL _getpid(void) _EWL_CANT_THROW { return getpid(); }

int _EWL_CDECL _isatty(int fildes) _EWL_CANT_THROW { return isatty(fildes); }
...
int _EWL_CDECL _rmdir(const char *path) _EWL_CANT_THROW { return rmdir(path); }
...
int _EWL_CDECL _write(int fildes, const void *buf,
                      size_t count) _EWL_CANT_THROW {
...
_EWL_IMP_EXP_C
    _EWL_POSIX_PARAMS _EWL_CDECL _umask(_EWL_POSIX_PARAMS) _EWL_CANT_THROW;
...
_EWL_IMP_EXP_C int _EWL_CDECL
_utime(const char *, _EWL_STRUCT_UTIMEBUF_TYPE utimbuf *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL _utimes(const char *path,
                                      struct timeval buf[2]) _EWL_CANT_THROW;

int _EWL_CDECL _utime(const char *path,
                      _EWL_STRUCT_UTIMEBUF_TYPE utimbuf *buf) _EWL_CANT_THROW {
  return utime(path, buf);
}

int _EWL_CDECL _utimes(const char *path,
                       struct timeval buf[2]) _EWL_CANT_THROW {
