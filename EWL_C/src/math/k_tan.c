...
/* $Id: k_tan.c,v 1.1 2012/06/01 15:48:41 b11883 Exp $ */
/*
 * ====================================================
...
#ifdef __STDC__
f64_t _EWL_MATH_CDECL __kernel_tan(f64_t x, f64_t y, int32_t iy)
#else
f64_t __kernel_tan(x, y, iy) f64_t x, y;
int32_t iy;
#endif
{
  f64_t z, r, v, w, s;
  ...
  if (ix < 0x3e300000uL) {          /* x < 2**-28 */
    if ((int32_t)x == 0L) {         /* generate inexact */
      ...
      if (((ix | GET_DOUBLE_ULO_WORD(x)) | (uint32_t)(iy + 1)) == 0uL) {
