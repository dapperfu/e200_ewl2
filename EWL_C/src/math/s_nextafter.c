...
#endif
{
  ...
  if (((ix >= 0x7ff00000uL) &&
       (((ix - 0x7ff00000uL) | lx) != 0uL)) || /* x is nan */
      ((iy >= 0x7ff00000uL) &&
       (((iy - 0x7ff00000uL) | ly) != 0uL))) { /* y is nan */
  ...
  if ((ix | lx) == 0uL) { /* x == 0 */
    GET_DOUBLE_UHI_WORD(x) =
        (uint32_t)hy & 0x80000000uL; /* return +-minsubnormal */
