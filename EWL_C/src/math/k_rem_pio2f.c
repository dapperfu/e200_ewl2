...
#ifdef __STDC__
int32_t __kernel_rem_pio2f(const f32_t *x, f32_t *y, int32_t e0, int32_t nx,
                           int32_t prec, const int32_t *ipio2)
#else
int32_t __kernel_rem_pio2f(x, y, e0, nx, prec, ipio2) f32_t x[], y[];
int_t e0, nx, prec;
int32_t ipio2[];
#endif
{
