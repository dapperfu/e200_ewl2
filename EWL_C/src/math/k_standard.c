...
/* $Id: k_standard.c,v 1.1 2012/06/01 15:48:41 b11883 Exp $ */
/*
 * ====================================================
...
static f64_t zero = 0.0; /* used as const */
...
#ifdef __STDC__
f64_t _EWL_MATH_CDECL __kernel_standard(f64_t x, f64_t y, int32_t type)
#else
f64_t __kernel_standard(x, y, type) f64_t x, y;
int32_t type;
#endif
{
