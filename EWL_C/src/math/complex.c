...
static _EWL_INLINE long double complex polarl(long double r,
                                              long double theta) {
...
long double complex _EWL_CDECL casinl(long double complex z) {
  long double complex y =
      clogl(csqrtl(1.0 - z * z) - cimagl(z) + creall(z) * I);
  return cimagl(y) - creall(y) * I;
}
...
double _EWL_CDECL cabs(double complex z) { return hypot(creal(z), cimag(z)); }

float _EWL_CDECL cabsf(float complex z) { return hypotf(crealf(z), cimagf(z)); }
...
long double complex _EWL_CDECL cpowl(long double complex x,
                                     long double complex y) {
...
double _EWL_CDECL carg(double complex z) { return atan2(cimag(z), creal(z)); }

float _EWL_CDECL cargf(float complex z) { return atan2f(cimagf(z), crealf(z)); }
