...
#ifdef __STDC__
MISRA_QUIET_LINT_03()
static const f32_t one = 1.0F, Zero[] = {
                                   0.0F,
                                   -0.0F,
};
#else
MISRA_QUIET_LINT_03()
static f32_t one = 1.0F, Zero[] = {
                             0.0F,
                             -0.0F,
};
#endif
...
MISRA_EXCEPTION_RULE_12_7a() MISRA_EXCEPTION_RULE_12_7b()
    MISRA_EXCEPTION_RULE_13_7() MISRA_EXCEPTION_RULE_20_5()
#ifdef __STDC__
        f32_t __ieee754_fmodf(f32_t x, f32_t y)
#else
        f32_t __ieee754_fmodf(x, y) f32_t x,
    y;
#endif
{
