...
int32_t __double_max[] = {0x7FFEFFFFL, (int32_t)0xFFFFFFFFL,
                          (int32_t)0xFFFF0000L};
...
int32_t __extended_max[] = {0x7FFE0000L, (int32_t)0xFFFFFFFFL,
                            (int32_t)0xFFFFFFFFL};
...
int32_t __extended_nan[] = {0x7FFF0000L, (int32_t)0xFFFFFFFFL,
                            (int32_t)0xFFFFFFFFL};

#elif (_EWL_LONG_DOUBLE_SIZE == 80)

int32_t __extended_min[] = {0x00018000L, 0L, 0L};
int32_t __extended_max[] = {0x7FFEFFFFL, (int32_t)0xFFFFFFFFL,
                            (int32_t)0xFFFF0000L};
