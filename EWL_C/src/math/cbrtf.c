...
_EWL_IMP_EXP_C f32_t _EWL_MATH_CDECL cbrtf(f32_t x) {
  ...
  MISRA_EXCEPTION_RULE_1_2c() MISRA_EXCEPTION_RULE_11_4() ix = (uint32_t *)&x;
  ...
  *ix |= 0x3F000000u;
  ...
  x = (f32_t)(
      (0.164705865585441 +
       ((13.2513868634597 +
         ((115.1358553761178 +
           ((181.9414139157457 + (41.95971194004274 * xd)) * xd)) *
          xd)) *
        xd)) /
      (1.0 + ((33.30169492280659 +
               ((161.6940396106312 +
                 ((142.8167287366127 + (13.64061797885738 * xd)) * xd)) *
                xd)) *
              xd)));
  exponent /= 3;
  MISRA_EXCEPTION_RULE_10_3()
