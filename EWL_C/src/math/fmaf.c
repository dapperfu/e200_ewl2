...
_EWL_IMP_EXP_C f32_t _EWL_MATH_CDECL fmaf(f32_t x, f32_t y, f32_t z) {
  ...
  MISRA_EXCEPTION_RULE_1_2c() MISRA_EXCEPTION_RULE_11_4() uint32_t x_i =
      *(uint32_t *)&x;
  MISRA_EXCEPTION_RULE_1_2c() MISRA_EXCEPTION_RULE_11_4() uint32_t y_i =
      *(uint32_t *)&y;
  MISRA_EXCEPTION_RULE_1_2c() MISRA_EXCEPTION_RULE_11_4() uint32_t z_i =
      *(uint32_t *)&z;
  /* extract exponent */
  ...
  if ((x == 0.0F) || (ex == 0x7F800000L) || (y == 0.0F) ||
      (ey == 0x7F800000L) || (z == 0.0F) || (ez == 0x7F800000L)) {
    MISRA_EXCEPTION_RULE_14_7()
    return (x * y) + z;
  }
#endif /* _EWL_INCOMPLETE_IEEE_EXCEPTION_MODEL */
  ...
  /* Perform p = x * y
     p will be 57 bits stored in a uint64_t, p_i (only 48 bits are actually
     generated) */
    ...
    if (shift > 0L) {
      ...
      if (shift < 0L) {
        ...
        /* shift q right by shift bits, and capture lost bits in xq
           0 < shift < 48 */
        MISRA_EXCEPTION_RULE_10_3()
        xq = (uint32_t)(((0xFFFFFFFFFFFFFFFFULL >> (64L - shift)) & q_i) !=
                        0ULL);
        q_i >>= shift;
        ez = ep;
      }
  ...
  if (p_i != 0ULL) {
    ...
    MISRA_EXCEPTION_RULE_1_2c() MISRA_EXCEPTION_RULE_11_4() * (uint32_t *)&x =
        sp;
    MISRA_EXCEPTION_RULE_14_7()
    return x;
  }
  if (shift > 0L) {
    ...
    if (shift < 0L) {
      ...
      MISRA_EXCEPTION_RULE_10_3()
      xp |=
          (uint32_t)(((0xFFFFFFFFFFFFFFFFULL >> (64L - shift)) & p_i) != 0ULL);
      p_i >>= shift;
      ep += shift;
    }
  }
  ...
  case 1: /* to nearest (round to even on tie) */
    if ((p_i & 0x0000000080000000ULL) &&
        ((p_i & 0x0000000100000000ULL) || (p_i & 0x000000007FFFFFFFULL) ||
         xp)) {
