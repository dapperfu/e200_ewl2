...
#ifdef __STDC__
int32_t _EWL_MATH_CDECL __kernel_rem_pio2(const f64_t *x, f64_t *y, int32_t e0,
                                          int32_t nx, int32_t prec,
                                          const int32_t *ipio2)
#else
int32_t __kernel_rem_pio2(x, y, e0, nx, prec, ipio2) f64_t x[], y[];
int32_t e0, nx, prec;
int32_t ipio2[];
#endif
{
