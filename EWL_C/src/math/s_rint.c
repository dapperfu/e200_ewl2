...
#endif
{
  ...
  if (j0 < 20L) {
    if (j0 < 0L) {
      ...
      MISRA_EXCEPTION_RULE_10_3()
      i0 = (int32_t)((uint32_t)i0 |
                     (((i1 | (uint32_t) - (int32_t)i1) >> 12) & 0x80000uL));
      GET_DOUBLE_HI_WORD(x) = i0;
      w = TWO52[sx] + x;
      t = w - TWO52[sx];
      i0 = GET_DOUBLE_HI_WORD(t);
      GET_DOUBLE_UHI_WORD(t) =
          ((uint32_t)i0 & 0x7fffffffuL) | ((uint32_t)sx << 31);
      MISRA_EXCEPTION_RULE_14_7()
      return t;
    } else {
      i = (0x000fffffuL) >> j0;
