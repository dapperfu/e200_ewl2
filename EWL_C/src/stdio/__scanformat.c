...
#define vec_va_arg(ap)                                                         \
  (*(((MWVector128 *)(ap = (char_t *)((((uint32_t)ap + 15) & ~(15)) + 16))) -  \
     1))
...
#define set_char_map(map, ch)                                                  \
  (map[(uchar_t)ch >> 3] |= (uchar_t)(1u << ((uchar_t)ch & 7u)))
...
static const char_t *parse_format(const char_t *format_string, va_list *arg,
                                  scan_format *format)
#else
static const char_t *parse_format(const char_t *format_string,
                                  scan_format *format)
#endif /* __ALTIVEC__ */
{
...
/* dsp56800 uses 16-bit pointers*/
  ...
  case 's':
...

    {
      ...
      f.char_set[1] =
          0xC1u; /* sets bits for HT, LF, VT, FF, and CR chars to zero */
...
int_t __sformatter(int_t(_EWL_CDECL *ReadProc)(void *a, int_t b, int_t c),
                   void *ReadProcArg, const char_t *format_str, va_list arg,
                   int_t is_secure) {
...
#define GOTO_GET_REMAINING_VEC_FIELDS(lbl)                                     \
  if (!match_failure) {                                                        \
    if ((c = (*ReadProc)(ReadProcArg, 0, (int_t)__GetAChar)) != EOF &&         \
  ...
  while (!terminate && ((format_char = *format_ptr) != 0)) {
    ...
    if ((format_char != '%') && (!match_failure)) {
      if ((c = (char_t)(*ReadProc)(ReadProcArg, 0, (int_t)__GetAChar)) !=
          format_char) {
        (void)(*ReadProc)(ReadProcArg, c, (int_t)__UngetAChar);
        if (!is_secure) {
          MISRA_EXCEPTION_RULE_14_4()
    ...
    if ((format.conversion_char != 'n') && (!match_failure) &&
        (*ReadProc)(ReadProcArg, 0, (int_t)__TestForError)) {
      if (!is_secure) {
        MISRA_EXCEPTION_RULE_14_4()
        goto exit;
      } else {
    ...
    signed_int:
      ...
      if (match_failure) {
        ...
        if ((format.argument_options == long_long_argument)
          ...
          u_long_long_num =
              __strtoull(base, format.field_width, ReadProc, ReadProcArg,
          ...
          _EWL_LONGLONG_PRINTF_SCANF) */
        {
          u_long_num = __strtoul(base, format.field_width, ReadProc,
                                 ReadProcArg, &num_chars, &negative, &overflow);
        }
        ...
        if ((format.argument_options == long_long_argument)
          ...
          if (negative &&
              ((uint64_t)u_long_long_num != 0x8000000000000000ULL)) {
    ...
    signed_int_assign:
...
#if defined(__m56800E__)
      {
        ...
        case normal_argument:
          if (arg_iptr) {
            (*((int_t *)arg_iptr)) = long_num;
          }
          break;
        case short_argument:
          if (arg_iptr) {
            (*((int16_t *)arg_iptr)) = long_num;
          }
          break;
        case long_argument:
          if (arg_iptr) {
            (*((int32_t *)arg_iptr)) = long_num;
          }
          break;
        case char_argument:
          if (arg_ptr) {
            (*((int8_t *)arg_ptr)) = long_num;
          }
          break;
#if _EWL_LONGLONG && (_EWL_C99_PRINTF_SCANF || _EWL_LONGLONG_PRINTF_SCANF)
        case long_long_argument:
          if (arg_iptr) {
            (*((int64_t *)arg_iptr)) = long_long_num;
          }
          break;
#endif /* _EWL_LONGLONG && (_EWL_C99_PRINTF_SCANF ||                           \
          _EWL_LONGLONG_PRINTF_SCANF) */
      ...
      if (arg_ptr) {
        ...
        switch (format.argument_options) {
        case normal_argument:
          *(int_t *)arg_ptr = long_num;
          break;
        case char_argument:
          *(int8_t *)arg_ptr = (int8_t)long_num;
          break;
        case short_argument:
          *(int16_t *)arg_ptr = (int16_t)long_num;
          break;
        case long_argument:
          *(int32_t *)arg_ptr = long_num;
          break;
#if _EWL_C99_PRINTF_SCANF
#if _EWL_LONGLONG_PRINTF_SCANF
        ...
        case size_t_argument:
          *(size_t *)arg_ptr = (uint_t)long_num;
          break;
    ...
    unsigned_int_assign:
...
#if defined(__m56800E__)
      {
        ...
        case normal_argument:
          if (arg_iptr)
            (*((uint_t *)arg_iptr)) = u_long_num;
          break;
        case short_argument:
          if (arg_iptr)
            (*((uint16_t *)arg_iptr)) = u_long_num;
          break;
        case long_argument:
          if (arg_iptr)
            (*((uint32_t *)arg_iptr)) = u_long_num;
          break;
        case char_argument:
          if (arg_ptr)
            (*((uchar_t *)arg_ptr)) = u_long_num;
          break;
#if _EWL_C99_PRINTF_SCANF && _EWL_LONGLONG_PRINTF_SCANF
        case long_long_argument:
          if (arg_iptr)
            (*((uint64_t *)arg_iptr)) = u_long_long_num;
          break;
      ...
      if (arg_ptr) {
        ...
        switch (format.argument_options) {
        case normal_argument:
          *(uint_t *)arg_ptr = u_long_num;
          break;
        case char_argument:
          *(uchar_t *)arg_ptr = (uchar_t)u_long_num;
          break;
        case short_argument:
          *(uint16_t *)arg_ptr = (uint16_t)u_long_num;
          break;
        case long_argument:
          *(uint32_t *)arg_ptr = (uint32_t)u_long_num;
          break;

#if _EWL_C99_PRINTF_SCANF
#if _EWL_LONGLONG_PRINTF_SCANF
        case intmax_argument:
          *(intmax_t *)arg_ptr = (int64_t)u_long_long_num;
          break;
#else
        case intmax_argument:
        ...
        case size_t_argument:
          *(size_t *)arg_ptr = u_long_num;
          break;
        case ptrdiff_argument:
          *(ptrdiff_t *)arg_ptr = (int_t)u_long_num;
          break;
#endif /* _EWL_C99_PRINTF_SCANF */
#if _EWL_LONGLONG_PRINTF_SCANF
        case long_long_argument:
          *(uint64_t *)arg_ptr = u_long_long_num;
          break;
#endif /* _EWL_LONGLONG_PRINTF_SCANF */
        }
    ...
    flt:
      ...
      if (match_failure) {
        ...
        long_double_num = __strtold(format.field_width, ReadProc, ReadProcArg,
                                    &num_chars, &overflow);
        if (!num_chars) {
          if (!is_secure) {
            MISRA_EXCEPTION_RULE_14_4()
...
#define arg_ptr arg_fptr
        ...
        if (arg_ptr) {
          ...
          switch (format.argument_options) {
          case normal_argument:
            *(f32_t *)arg_ptr = (f32_t)long_double_num;
            break;
          case double_argument:
            *(f64_t *)arg_ptr = long_double_num;
            break;
          case long_double_argument:
            *(ldbl_t *)arg_ptr = long_double_num;
            break;
          }
...
#undef arg_ptr
    ...
    case 'c':
      ...
      if (format.vec) {
        ...
        str1:
          ...
          while (width-- &&
                 (c = (*ReadProc)(ReadProcArg, 0, (int_t)__GetAChar)) != EOF) {
            *ptr++ = c;
            ++num_chars;
          }
        ...
        str2:
          ...
          while (format.field_width-- &&
                 ((rval = ((*ReadProc)(ReadProcArg, 0, (int_t)__GetAChar))) !=
                  EOF)) {
            c = rval;
            ++num_chars;
          }
      ...
      if (arg_ptr) {
        ...
        if (match_failure) {
          ...
          while (format.field_width-- &&
                 (!is_secure ||
                  ((elem_valid = ((int_t)elem_maxsize > num_chars)) != 0)) &&
                 ((rval = ((*ReadProc)(ReadProcArg, 0, (int_t)__GetAChar))) !=
                  EOF)) {
            c = rval;
#if _EWL_WIDE_CHAR
...
#if defined(__m56800E__)
    {
      ...
      if (arg_ptr) {
        ...
        switch (format.argument_options) {
        case normal_argument:
          *(int_t *)arg_ptr = chars_read;
          break;
        case short_argument:
          *(int16_t *)arg_ptr = (int16_t)chars_read;
          break;
        case long_argument:
          *(int32_t *)arg_ptr = chars_read;
          break;
        case char_argument:
          *arg_ptr = (char_t)chars_read;
          break;

#if _EWL_LONGLONG && (_EWL_C99_PRINTF_SCANF || _EWL_LONGLONG_PRINTF_SCANF)
        case long_long_argument:
          *(int64_t *)arg_ptr = chars_read;
          break;
#endif /* _EWL_LONGLONG && (_EWL_C99_PRINTF_SCANF ||                           \
          _EWL_LONGLONG_PRINTF_SCANF) */
        }
