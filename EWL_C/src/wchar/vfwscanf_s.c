...
int_t _EWL_CDECL vfwscanf_s(FILE * _EWL_RESTRICT stream, const wchar_t * _EWL_RESTRICT format, va_list arg)
{
	int_t retval;
	...
	retval = __wsformatter(__wFileRead, (void *)stream, format, arg, 1);
