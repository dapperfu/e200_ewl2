...
/*lint -e529, -e530 arguments and locals are often build dependent, turn off
 * usage warnings */
...
#if !defined(_No_Floating_Point_Regs) && !defined(__SPE__) && !defined(__VLE__)

#define fieldmask                                                              \
  255 /* which bits in the FPSCR do you want to affect? 255 = all of them */
...
#endif /* _EWL_C99_TC2_FENV */
{
   ...
   *  Returns zero if the representation was successfully stored. Otherwise, it
...
#endif /* _EWL_C99_TC2_FENV */
{
  ...
  __asm("\t mffs %0\n" /* load FPSCR in2 GPR */
        ...
        : "0"(FPSCR), "r"(FPSCR_Temp1), "r"(FPSCR_Temp3), "r"(*FPSCR_MemPtr),
          "r"(EXCEPTIONS), "1"(FPSCR_Temp2), "r"(*FLAG_Ptr));
#else
  asm
  {
		mffs FPSCR /* load FPSCR in2 GPR */
...
#endif /* _EWL_C99_TC2_FENV */
{
  ...
  __asm("\tand %2,%5,%7\n"
        ...
        : "r"(*FPSCR_MemPtr), "r"(FPSCR_Temp1), "r"(EXCEPTIONS), "0"(FPSCR),
          "1"(FPSCR_Temp2), "r"(FPSCR_Temp3), "r"(FLAG), "2"(mask));
#else
  asm
  {
...
#endif /* _EWL_C99_TC2_FENV */
{
  ...
  __asm("\tmffs %0\n"
        ...
        : "0"(FPSCR), "1"(FPSCR_Temp), "r"(*FPSCR_MemPtr), "r"(EXCEPTIONS),
          "r"(*FLAG_Ptr), "r"(FPSCR_Temp1));
#else
  asm
  {
		mffs FPSCR
...
_EWL_IMP_EXP_C int_t feholdexcept(fenv_t *envp) {
  ...
  __asm("\tmffs  %0\n" /* load FPSCR in2 GPR */
        ...
        : "r"(*FPSCR_MemPtr), "r"(EXCEPTIONS), "r"(*ENV_Ptr), "r"(mask),
          "r"(FPSCR_Temp2), "1"(FPSCR_Temp), "0"(FPSCR));
#else
  asm
  {
		mffs  FPSCR /* load FPSCR in2 GPR */
...
#endif /* _EWL_C99_TC2_FENV */
{
  ...
  __asm("\tmffs  %0\n" /* load FPSCR in2 GPR */
        ...
        : "0"(FPSCR), "1"(FPSCR_Temp1), "r"(*FPSCR_MemPtr), "r"(FPSCR_Temp2),
          "r"(EXCEPTIONS), "r"(FPSCR_Temp), "r"(ENV));
#else
  asm
  {
		mffs  FPSCR /* load FPSCR in2 GPR */
...
#endif /* _EWL_C99_TC2_FENV */
{
  ...
  __asm("\tmffs  %0\n" /* load FPSCR in2 GPR */
        ...
        "\tlwz   %7,  4(%2)\n" /* remove the FE exceptions */
        : "=r"(FPSCR), "=r"(FPSCR_Temp2)
        : "0"(FPSCR), "1"(FPSCR_Temp2), "r"(*FPSCR_MemPtr), "r"(FPSCR_Temp1),
          "r"(EXCEPTIONS), "r"(ENV), "r"(FPSCR_Temp3));
#else
  asm
  {
		mffs  FPSCR /* load FPSCR in2 GPR */
...
/** The fegetround function gets the current rounding direction.
 */
_EWL_IMP_EXP_C int_t fegetround(void) { return 0; /* nearest */ }

/** The fesetround function establishes the rounding direction represented by
 * its argument round. If the argument is not equal to the value of a rounding
 * direction macro, the rounding direction is not changed.
 */
_EWL_IMP_EXP_C int_t fesetround(int_t excepts) { return 0; /* nearest */ }
