...
#ifdef __ALTIVEC__
void _EWL_CDECL __init_align_pool_obj(mem_pool_obj *pool_obj,
                                      char align) _EWL_CANT_THROW;
#endif /* __ALTIVEC__ */

void _EWL_CDECL __init_pool_obj(mem_pool_obj *pool_obj) _EWL_CANT_THROW;
int _EWL_CDECL __pool_preallocate(mem_pool_obj *pool_obj,
                                  mem_size) _EWL_CANT_THROW;
void _EWL_CDECL __pool_preassign(mem_pool_obj *pool_obj, void *,
                                 mem_size) _EWL_CANT_THROW;
void *_EWL_CDECL __pool_alloc(mem_pool_obj *pool_obj, mem_size) _EWL_CANT_THROW;
void *_EWL_CDECL __pool_alloc_clear(mem_pool_obj *pool_obj,
                                    mem_size) _EWL_CANT_THROW;
void *_EWL_CDECL __pool_realloc(mem_pool_obj *pool_obj, void *,
                                mem_size) _EWL_CANT_THROW;
void _EWL_CDECL __pool_free(mem_pool_obj *pool_obj, void *) _EWL_CANT_THROW;

_EWL_IMP_EXP_C void _EWL_CDECL __pool_free_all(mem_pool_obj *pool_obj)
    _EWL_CANT_THROW;
...
_EWL_IMP_EXP_C void _EWL_CDECL __init_pool_obj(__mem_pool *pool_obj)
    _EWL_CANT_THROW;
_EWL_IMP_EXP_C void *_EWL_CDECL __pool_alloc(__mem_pool *pool_obj,
                                             __std(size_t)
                                                 size) _EWL_CANT_THROW;
_EWL_IMP_EXP_C void _EWL_CDECL __pool_free(__mem_pool *pool_obj,
                                           void *ptr) _EWL_CANT_THROW;
_EWL_IMP_EXP_C void *_EWL_CDECL __pool_realloc(__mem_pool *pool_obj, void *ptr,
                                               __std(size_t)
                                                   size) _EWL_CANT_THROW;
_EWL_IMP_EXP_C void *_EWL_CDECL __pool_alloc_clear(__mem_pool *pool_obj,
                                                   __std(size_t)
                                                       size) _EWL_CANT_THROW;
_EWL_IMP_EXP_C void _EWL_CDECL __pool_free_all(__mem_pool *pool)
    _EWL_CANT_THROW;
_EWL_IMP_EXP_C void _EWL_CDECL __malloc_free_all(void) _EWL_CANT_THROW;

#if !_EWL_OS_ALLOC_HEAP_SUPPORT
_EWL_IMP_EXP_C int _EWL_CDECL init_alloc(void *, __std(size_t)
                                                     heap_size) _EWL_CANT_THROW;
#endif /* !_EWL_OS_ALLOC_HEAP_SUPPORT */
