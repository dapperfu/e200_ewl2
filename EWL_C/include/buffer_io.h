...
int _EWL_CDECL __load_buffer(__std(FILE) *, __std(size_t) * bytes_loaded,
                             int alignment) _EWL_CANT_THROW;

void _EWL_CDECL __prep_buffer(__std(FILE) *) _EWL_CANT_THROW;
int _EWL_CDECL __flush_buffer(__std(FILE) *,
                              __std(size_t) * bytes_flushed) _EWL_CANT_THROW;
