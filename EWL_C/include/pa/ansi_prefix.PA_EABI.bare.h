...
#define _EWL_HEAP_EXTERN_PROTOTYPES                                            \
  __attribute__((section(".init_vle"))) extern char_t                          \
      _heap_addr[]; /* starting address for heap */                            \
  __attribute__((section(".init_vle"))) extern char_t                          \
      _heap_end[]; /* address after end byte of heap */
#else
#define _EWL_HEAP_EXTERN_PROTOTYPES                                            \
  __attribute__((section(                                                      \
      ".init"))) extern char_t _heap_addr[]; /* starting address for heap */   \
  __attribute__((section(".init"))) extern char_t                              \
      _heap_end[]; /* address after end byte of heap */
...
#define _EWL_HEAP_EXTERN_PROTOTYPES                                            \
  ...
  __declspec(                                                                  \
      section                                                                  \
      ".init") extern char_t _heap_end[]; /* address after end byte of heap */
#endif
#endif
#endif
...
#define _EWL_STRERROR_KNOWS_ERROR_NAMES                                        \
  0 /* 0: for reduced code and data size by reducing EWL functionality */
#endif

#ifndef _EWL_ASSERT_DISPLAYS_FUNC
#define _EWL_ASSERT_DISPLAYS_FUNC                                              \
  1 /* 0: for reduced code and data size by reducing EWL functionality */
#endif
...
#define _EWL_C_LOCALE_ONLY                                                     \
  1 /* 1: for reduced code and data size by reducing EWL functionality */
#endif

#ifndef _EMBEDDED_WARRIOR_MALLOC
#define _EMBEDDED_WARRIOR_MALLOC                                               \
  1 /* 1: for reduced code and data size by reducing EWL functionality */
#endif
...
#define _EWL_C99_PRINTF_SCANF                                                  \
  0 /* 0: for reduced code and data size by reducing EWL functionality */
#endif

#ifndef _EWL_FLOATING_POINT_PRINTF_SCANF
#define _EWL_FLOATING_POINT_PRINTF_SCANF                                       \
  0 /* 0: for reduced code and data size by reducing EWL functionality */
#endif
...
#elif __GNUC__
#define _EWL_DOUBLE_IS_FOUR_BYTES (__SIZEOF_DOUBLE__ == 4)
#else
