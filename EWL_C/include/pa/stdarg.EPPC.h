...
#define __greg_va_type(mod)                                                    \
  (__va_regtyp(mod) ? /* 1 or 2 for int or long long int */                    \
       ((sizeof(mod) > 4) ? 2 : 1)                                             \
...
#define __greg_va_type(mod)                                                                                                                                      \
  (__va_regtyp(mod)                                                                                                                                              \
       ? /* if a register type, is it a double - then 3.  */ /* appears 4                                                                                        \
                                                                means float                                                                                      \
                                                                (ppc602                                                                                          \
                                                                lunacy) */ /* 1 or 2 for int or long long int */ /* 5 will be taken to mean an AltiVec vector */ \
       (__va_float(mod)                                                                                                                                          \
            ? 3                                                                                                                                                  \
            : (__va_vector(mod) ? 5 : ((sizeof(mod) > 4) ? 2 : 1)))                                                                                              \
       : /* if not a register type, then pass a 0 */                                                                                                             \
       0)
#endif /* __FloatSingle */
#else  /* if !EDG */
#define __greg_va_type(mod)                                                                                                                                      \
  (__va_regtyp(mod)                                                                                                                                              \
       ...
       (__va_float(mod)                                                                                                                                          \
            ? 3                                                                                                                                                  \
            : ((sizeof(mod) == 16) ? 5 : ((sizeof(mod) > 4) ? 2 : 1)))                                                                                           \
       : /* if not a register type, then pass a 0 */                                                                                                             \
       0)
#endif
