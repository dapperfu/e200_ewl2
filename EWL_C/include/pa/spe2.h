...
#define __builtin_spe2_evlbbsplatbu(u, i)                                      \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlbbsplatbu %1,%2*1(%0)" : "+r"(u), "=r"(d) : "i"(i));    \
    d;                                                                         \
  })
#define __builtin_spe2_evlbbsplatbmx(m, x)                                     \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlbbsplatbmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));      \
    d;                                                                         \
  })
#define __builtin_spe2_evldbu(u, i)                                            \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evldbu %1,%2*8(%0)" : "+r"(u), "=r"(d) : "i"(i));          \
    d;                                                                         \
  })
#define __builtin_spe2_evldbmx(m, x)                                           \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evldbmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));            \
    d;                                                                         \
  })
#define __builtin_spe2_evlddu(u, i)                                            \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlddu %1,%2*8(%0)" : "+r"(u), "=r"(d) : "i"(i));          \
    d;                                                                         \
  })
#define __builtin_spe2_evlddmx(m, x)                                           \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlddmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));            \
    d;                                                                         \
  })
#define __builtin_spe2_evldhu(u, i)                                            \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evldhu %1,%2*8(%0)" : "+r"(u), "=r"(d) : "i"(i));          \
    d;                                                                         \
  })
#define __builtin_spe2_evldhmx(m, x)                                           \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evldhmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));            \
    d;                                                                         \
  })
#define __builtin_spe2_evldwu(u, i)                                            \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evldwu %1,%2*8(%0)" : "+r"(u), "=r"(d) : "i"(i));          \
    d;                                                                         \
  })
#define __builtin_spe2_evldwmx(m, x)                                           \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evldwmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));            \
    d;                                                                         \
  })
#define __builtin_spe2_evlhhesplatu(u, i)                                      \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlhhesplatu %1,%2*2(%0)" : "+r"(u), "=r"(d) : "i"(i));    \
    d;                                                                         \
  })
#define __builtin_spe2_evlhhesplatmx(m, x)                                     \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlhhesplatmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));      \
    d;                                                                         \
  })
#define __builtin_spe2_evlhhossplatu(u, i)                                     \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlhhossplatu %1,%2*2(%0)" : "+r"(u), "=r"(d) : "i"(i));   \
    d;                                                                         \
  })
#define __builtin_spe2_evlhhossplatmx(m, x)                                    \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlhhossplatmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));     \
    d;                                                                         \
  })
#define __builtin_spe2_evlhhousplatu(u, i)                                     \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlhhousplatu %1,%2*2(%0)" : "+r"(u), "=r"(d) : "i"(i));   \
    d;                                                                         \
  })
#define __builtin_spe2_evlhhousplatmx(m, x)                                    \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlhhousplatmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));     \
    d;                                                                         \
  })
#define __builtin_spe2_evlhhsplathu(u, i)                                      \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlhhsplathu %1,%2*2(%0)" : "+r"(u), "=r"(d) : "i"(i));    \
    d;                                                                         \
  })
#define __builtin_spe2_evlhhsplathmx(m, x)                                     \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlhhsplathmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));      \
    d;                                                                         \
  })
#define __builtin_spe2_evlwbeu(u, i)                                           \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwbeu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));         \
    d;                                                                         \
  })
#define __builtin_spe2_evlwbemx(m, x)                                          \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwbemx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));           \
    d;                                                                         \
  })
#define __builtin_spe2_evlwbosu(u, i)                                          \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwbosu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));        \
    d;                                                                         \
  })
#define __builtin_spe2_evlwbosmx(m, x)                                         \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwbosmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));          \
    d;                                                                         \
  })
#define __builtin_spe2_evlwbouu(u, i)                                          \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwbouu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));        \
    d;                                                                         \
  })
#define __builtin_spe2_evlwboumx(m, x)                                         \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwboumx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));          \
    d;                                                                         \
  })
#define __builtin_spe2_evlwbsplatwu(u, i)                                      \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwbsplatwu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));    \
    d;                                                                         \
  })
#define __builtin_spe2_evlwbsplatwmx(m, x)                                     \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwbsplatwmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));      \
    d;                                                                         \
  })
#define __builtin_spe2_evlwheu(u, i)                                           \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwheu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));         \
    d;                                                                         \
  })
#define __builtin_spe2_evlwhemx(m, x)                                          \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwhemx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));           \
    d;                                                                         \
  })
#define __builtin_spe2_evlwhosu(u, i)                                          \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwhosu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));        \
    d;                                                                         \
  })
#define __builtin_spe2_evlwhosmx(m, x)                                         \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwhosmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));          \
    d;                                                                         \
  })
#define __builtin_spe2_evlwhouu(u, i)                                          \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwhouu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));        \
    d;                                                                         \
  })
#define __builtin_spe2_evlwhoumx(m, x)                                         \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwhoumx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));          \
    d;                                                                         \
  })
#define __builtin_spe2_evlwhsplatu(u, i)                                       \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwhsplatu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));     \
    d;                                                                         \
  })
#define __builtin_spe2_evlwhsplatmx(m, x)                                      \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwhsplatmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));       \
    d;                                                                         \
  })
#define __builtin_spe2_evlwhsplatwu(u, i)                                      \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwhsplatwu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));    \
    d;                                                                         \
  })
#define __builtin_spe2_evlwhsplatwmx(m, x)                                     \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwhsplatwmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));      \
    d;                                                                         \
  })
#define __builtin_spe2_evlwwsplatu(u, i)                                       \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwwsplatu %1,%2*4(%0)" : "+r"(u), "=r"(d) : "i"(i));     \
    d;                                                                         \
  })
#define __builtin_spe2_evlwwsplatmx(m, x)                                      \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evlwwsplatmx %1,%0,%2" : "+r"(m), "=r"(d) : "r"(x));       \
    d;                                                                         \
  })

#define __builtin_spe2_evstdbu(d, u, i)                                        \
  __asm volatile("evstdbu %1,%2*8(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstdbmx(d, m, x)                                       \
  __asm volatile("evstdbmx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstddu(d, u, i)                                        \
  __asm volatile("evstddu %1,%2*8(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstddmx(d, m, x)                                       \
  __asm volatile("evstddmx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstdhu(d, u, i)                                        \
  __asm volatile("evstdhu %1,%2*8(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstdhmx(d, m, x)                                       \
  __asm volatile("evstdhmx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstdwu(d, u, i)                                        \
  __asm volatile("evstdwu %1,%2*8(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstdwmx(d, m, x)                                       \
  __asm volatile("evstdwmx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evsthbu(d, u, i)                                        \
  __asm volatile("evsthbu %1,%2*2(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evsthbmx(d, m, x)                                       \
  __asm volatile("evsthbmx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstwbu(d, u, i)                                        \
  __asm volatile("evstwbu %1,%2*4(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstwbmx(d, m, x)                                       \
  __asm volatile("evstwbmx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstwbeu(d, u, i)                                       \
  __asm volatile("evstwbeu %1,%2*4(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstwbemx(d, m, x)                                      \
  __asm volatile("evstwbemx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstwbou(d, u, i)                                       \
  __asm volatile("evstwbou %1,%2*4(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstwbomx(d, m, x)                                      \
  __asm volatile("evstwbomx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstwheu(d, u, i)                                       \
  __asm volatile("evstwheu %1,%2*4(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstwhemx(d, m, x)                                      \
  __asm volatile("evstwhemx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstwhou(d, u, i)                                       \
  __asm volatile("evstwhou %1,%2*4(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstwhomx(d, m, x)                                      \
  __asm volatile("evstwhomx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstwweu(d, u, i)                                       \
  __asm volatile("evstwweu %1,%2*4(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstwwemx(d, m, x)                                      \
  __asm volatile("evstwwemx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))
#define __builtin_spe2_evstwwou(d, u, i)                                       \
  __asm volatile("evstwwou %1,%2*4(%0)" : "+r"(u) : "r"(d), "i"(i))
#define __builtin_spe2_evstwwomx(d, m, x)                                      \
  __asm volatile("evstwwomx %1,%0,%2" : "+r"(m) : "r"(d), "r"(x))

#define __builtin_spe2_evdotp4hgasmfaa3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hgasmfaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotp4hgasmiaa3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hgasmiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotp4hgasumiaa3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hgasumiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotp4hgaumiaa3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hgaumiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotp4hgssmfaa3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hgssmfaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotp4hgssmiaa3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hgssmiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotp4hxgasmfaa3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hxgasmfaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotp4hxgasmiaa3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hxgasmiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotp4hxgssmfaa3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hxgssmfaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotp4hxgssmiaa3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotp4hxgssmiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpbasmiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpbasmiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpbasumiaaw3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpbasumiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpbaumiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpbaumiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphasmiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphasmiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphassfaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphassfaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphassfraaw3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphassfraaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphassiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphassiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphasumiaaw3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphasumiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphasusiaaw3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphasusiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphaumiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphaumiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphausiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphausiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphihcsmiaaw3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphihcsmiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphihcssfaaw3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphihcssfaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphihcssfraaw3(a, b, c)                             \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphihcssfraaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));           \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphihcssiaaw3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphihcssiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphssmiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphssmiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphsssfaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphsssfaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphsssfraaw3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphsssfraaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotphsssiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotphsssiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotplohcsmiaaw3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotplohcsmiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotplohcssfaaw3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotplohcssfaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotplohcssfraaw3(a, b, c)                             \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotplohcssfraaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));           \
    d;                                                                         \
  })
#define __builtin_spe2_evdotplohcssiaaw3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotplohcssiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwasmiaa3(a, b, c)                                 \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwasmiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));               \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwassiaa3(a, b, c)                                 \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwassiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));               \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwasumiaa3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwasumiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwasusiaa3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwasusiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwaumiaa3(a, b, c)                                 \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwaumiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));               \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwausiaa3(a, b, c)                                 \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwausiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));               \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwcsmiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwcsmiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwcssfaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwcssfaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwcssfraaw3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwcssfraaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwcssiaaw3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwcssiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwgasmfaa3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwgasmfaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwgasmfraa3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwgasmfraa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwgssmfaa3(a, b, c)                                \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwgssmfaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));              \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwgssmfraa3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwgssmfraa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwssmiaa3(a, b, c)                                 \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwssmiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));               \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwsssiaa3(a, b, c)                                 \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwsssiaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));               \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwxgasmfaa3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwxgasmfaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwxgasmfraa3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwxgasmfraa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwxgssmfaa3(a, b, c)                               \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwxgssmfaa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));             \
    d;                                                                         \
  })
#define __builtin_spe2_evdotpwxgssmfraa3(a, b, c)                              \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evdotpwxgssmfraa3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));            \
    d;                                                                         \
  })
#define __builtin_spe2_evmar()                                                 \
  ({                                                                           \
    __ev64_opaque__ d;                                                         \
    __asm volatile("evmar %0" : "=r"(d));                                      \
    d;                                                                         \
  })
#define __builtin_spe2_evmwhssfaaw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwhssfaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evmwhssfanw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwhssfanw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evmwhssfraaw3(a, b, c)                                  \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwhssfraaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                \
    d;                                                                         \
  })
#define __builtin_spe2_evmwhssfranw3(a, b, c)                                  \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwhssfranw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                \
    d;                                                                         \
  })
#define __builtin_spe2_evmwlsmiaaw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwlsmiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evmwlsmianw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwlsmianw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evmwlssiaaw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwlssiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evmwlssianw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwlssianw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evmwlumiaaw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwlumiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evmwlumianw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwlumianw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evmwlusiaaw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwlusiaaw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evmwlusianw3(a, b, c)                                   \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evmwlusianw3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                 \
    d;                                                                         \
  })
#define __builtin_spe2_evinsb(a, b, c, s)                                      \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evinsb %0,%1,%3,%2" : "+r"(d) : "r"(b), "i"(c), "i"(s));            \
    d;                                                                         \
  })
#define __builtin_spe2_evinsh(a, b, c, s)                                      \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evinsh %0,%1,%3,%2" : "+r"(d) : "r"(b), "i"(c), "i"(s));            \
    d;                                                                         \
  })
#define __builtin_spe2_evperm2(a, b, c)                                        \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evperm2 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                      \
    d;                                                                         \
  })
#define __builtin_spe2_evperm3(a, b, c)                                        \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evperm3 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                      \
    d;                                                                         \
  })
#define __builtin_spe2_evselbit(a, b, c)                                       \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evselbit %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                     \
    d;                                                                         \
  })
#define __builtin_spe2_evselbitm0(a, b, c)                                     \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evselbitm0 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                   \
    d;                                                                         \
  })
#define __builtin_spe2_evselbitm1(a, b, c)                                     \
  ({                                                                           \
    __ev64_opaque__ d = a;                                                     \
    __asm("evselbitm1 %0,%1,%2" : "+r"(d) : "r"(b), "r"(c));                   \
    d;                                                                         \
  })
...
#define __ev_dotphsssi                                                         \
  __builtin_spe2_evdotphssmi // Alias, since no overflow can occur
#define __ev_dotphsssia                                                        \
  __builtin_spe2_evdotphssmia // Alias, since no overflow can occur
...
#define __ev_dotpwsssi                                                         \
  __builtin_spe2_evdotpwssmi // Alias, since no overflow can occur
#define __ev_dotpwsssia                                                        \
  __builtin_spe2_evdotpwsssia // Alias, since no overflow can occur
