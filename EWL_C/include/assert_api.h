...
_EWL_IMP_EXP_C void _EWL_CDECL __ewl_wchar_assertion_failed(
    wchar_t const *, char const *, char const *, int) _EWL_CANT_THROW;
#endif

_EWL_IMP_EXP_C void _EWL_CDECL __ewl_assertion_failed(char const *,
                                                      char const *,
                                                      char const *,
                                                      int) _EWL_CANT_THROW;
