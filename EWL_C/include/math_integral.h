...
#include <ansi_parms.h>
    ...
    defined(__cplusplus) && defined(__ANSI_OVERLOAD__) &&                      \
    defined(_EWL_INTEGRAL_MATH) &&                                             \
    !(__dest_os == __mac_os && defined(__FP__)) && !defined(__m56800E__)
...
template <class _T> struct __ewl_is_integral {
...
template <> struct __ewl_is_integral<signed char> {
  static const bool value = true;
};
template <> struct __ewl_is_integral<unsigned char> {
  static const bool value = true;
};
#if __option(wchar_type)
template <> struct __ewl_is_integral<wchar_t> {
  static const bool value = true;
};
#endif
template <> struct __ewl_is_integral<short> { static const bool value = true; };
template <> struct __ewl_is_integral<unsigned short> {
  static const bool value = true;
};
template <> struct __ewl_is_integral<int> { static const bool value = true; };
template <> struct __ewl_is_integral<unsigned int> {
  static const bool value = true;
};
template <> struct __ewl_is_integral<long> { static const bool value = true; };
template <> struct __ewl_is_integral<unsigned long> {
  static const bool value = true;
};
#if _EWL_LONGLONG
template <> struct __ewl_is_integral<long long> {
  static const bool value = true;
};
template <> struct __ewl_is_integral<unsigned long long> {
  static const bool value = true;
};
#endif

template <class _T> struct __ewl_is_floating {
  static const bool value = false;
};
template <> struct __ewl_is_floating<float> { static const bool value = true; };
template <> struct __ewl_is_floating<double> {
  static const bool value = true;
};
template <> struct __ewl_is_floating<long double> {
  static const bool value = true;
};

template <class _T> struct __ewl_is_arithmetic {
  static const bool value =
      __ewl_is_integral<_T>::value || __ewl_is_floating<_T>::value;
};

template <bool, class _T = void> struct __ewl_enable_if {};
template <class _T> struct __ewl_enable_if<true, _T> { typedef _T type; };

template <bool _B, class _If, class _Then> struct __ewl_if {
  typedef _If type;
};
template <class _If, class _Then> struct __ewl_if<false, _If, _Then> {
  typedef _Then type;
};

template <class _A1, class _A2 = void, class _A3 = void> class __ewl_promote {
private:
...
template <class _A1> class __ewl_promote<_A1, void, void> {
public:
  typedef typename __ewl_if<
      __ewl_is_arithmetic<_A1>::value,
      typename __ewl_if<__ewl_is_integral<_A1>::value, double, _A1>::type,
      char>::type type;
};

template <class _A1, class _A2> class __ewl_promote<_A1, _A2, void> {
private:
  typedef typename __ewl_promote<_A1>::type type1;
  typedef typename __ewl_promote<_A2>::type type2;
...
template <class _A1, class _A2> struct __ewl_is_same {
  static const bool value = false;
};

template <class _A1> struct __ewl_is_same<_A1, _A1> {
  static const bool value = true;
};
...
template <class _A1>
inline typename __ewl_enable_if<__ewl_is_integral<_A1>::value, double>::type
    _EWL_MATH_CDECL
    acos(_A1 x) {
...
inline typename __ewl_enable_if<__ewl_is_arithmetic<_A1>::value &&
                                    __ewl_is_arithmetic<_A2>::value,
                                typename __ewl_promote<_A1, _A2>::type>::type
    _EWL_MATH_CDECL
    atan2(_A1 x, _A2 y) {
  typedef typename __ewl_promote<_A1, _A2>::type r_type;
  char test[!(__ewl_is_same<_A1, r_type>::value &&
              __ewl_is_same<_A2, r_type>::value)];
  (void)test;
...
inline
    typename __ewl_enable_if<__ewl_is_arithmetic<_A1>::value &&
                                 __ewl_is_arithmetic<_A2>::value &&
                                 __ewl_is_arithmetic<_A3>::value,
                             typename __ewl_promote<_A1, _A2, _A3>::type>::type
        _EWL_MATH_CDECL
        fma(_A1 x, _A2 y, _A3 z) {
...
template <class _A1>
inline typename __ewl_enable_if<__ewl_is_integral<_A1>::value, int>::type
    _EWL_MATH_CDECL
    ilogb(_A1 x) {
...
template <class _A1>
inline typename __ewl_enable_if<__ewl_is_integral<_A1>::value, long long>::type
    _EWL_MATH_CDECL
    llrint(_A1 x) {
...
template <class _A1>
inline typename __ewl_enable_if<__ewl_is_integral<_A1>::value, long>::type
    _EWL_MATH_CDECL
    lrint(_A1 x) {
...
inline typename __ewl_enable_if<__ewl_is_integral<_A1>::value, double>::type
    _EWL_MATH_CDECL
    nexttoward(_A1 x, long double y) {
  return nexttoward((double)x, y);
}
...
inline typename __ewl_enable_if<__ewl_is_integral<_A1>::value, double>::type
    _EWL_MATH_CDECL
    scalbln(_A1 x, long y) {
  return scalbln((double)x, y);
}
