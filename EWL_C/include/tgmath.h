...
inline long double complex __ewl_acos(long double complex x) {
  return cacosl(x);
}
#endif
...
inline long double complex __ewl_acosh(long double complex x) {
  return cacoshl(x);
}
#endif
...
inline long double complex __ewl_asin(long double complex x) {
  return casinl(x);
}
#endif
...
inline long double complex __ewl_asinh(long double complex x) {
  return casinhl(x);
}
#endif
...
inline long double complex __ewl_atan(long double complex x) {
  return catanl(x);
}
#endif
...
inline long double __ewl_atan2(long double x, long double y) {
  return atan2l(x, y);
}

#undef atan2
#define atan2(x, y)                                                            \
  __ewl_atan2((__typeof__(__promote(x) + __promote(y)))(x),                    \
...
inline long double complex __ewl_atanh(long double complex x) {
  return catanhl(x);
}
#endif
...
inline long double __ewl_copysign(long double x, long double y) {
  return copysignl(x, y);
}

#undef copysign
#define copysign(x, y)                                                         \
  __ewl_copysign((__typeof__(__promote(x) + __promote(y)))(x),                 \
                 (__typeof__(__promote(x) + __promote(y)))(y))
...
inline long double complex __ewl_cosh(long double complex x) {
  return ccoshl(x);
}
#endif
...
inline long double __ewl_fdim(long double x, long double y) {
  return fdiml(x, y);
}

#undef fdim
#define fdim(x, y)                                                             \
  __ewl_fdim((__typeof__(__promote(x) + __promote(y)))(x),                     \
             (__typeof__(__promote(x) + __promote(y)))(y))
...
inline long double __ewl_fma(long double x, long double y, long double z) {
  return fmal(x, y, z);
}

#undef fma
#define fma(x, y, z)                                                           \
  __ewl_fma((__typeof__(__promote(x) + __promote(y) + __promote(z)))(x),       \
...
inline long double __ewl_fmax(long double x, long double y) {
  return fmaxl(x, y);
}

#undef fmax
#define fmax(x, y)                                                             \
  __ewl_fmax((__typeof__(__promote(x) + __promote(y)))(x),                     \
             (__typeof__(__promote(x) + __promote(y)))(y))

inline float __ewl_fmin(float x, float y) { return fminf(x, y); }
inline double __ewl_fmin(double x, double y) { return fmin(x, y); }
inline long double __ewl_fmin(long double x, long double y) {
  return fminl(x, y);
}

#undef fmin
#define fmin(x, y)                                                             \
  __ewl_fmin((__typeof__(__promote(x) + __promote(y)))(x),                     \
             (__typeof__(__promote(x) + __promote(y)))(y))

inline float __ewl_fmod(float x, float y) { return fmodf(x, y); }
inline double __ewl_fmod(double x, double y) { return fmod(x, y); }
inline long double __ewl_fmod(long double x, long double y) {
  return fmodl(x, y);
}

#undef fmod
#define fmod(x, y)                                                             \
  __ewl_fmod((__typeof__(__promote(x) + __promote(y)))(x),                     \
             (__typeof__(__promote(x) + __promote(y)))(y))
...
inline long double __ewl_hypot(long double x, long double y) {
  return hypotl(x, y);
}

#undef hypot
#define hypot(x, y)                                                            \
  __ewl_hypot((__typeof__(__promote(x) + __promote(y)))(x),                    \
              (__typeof__(__promote(x) + __promote(y)))(y))
...
inline long double __ewl_nextafter(long double x, long double y) {
  return nextafterl(x, y);
}

#undef nextafter
#define nextafter(x, y)                                                        \
  __ewl_nextafter((__typeof__(__promote(x) + __promote(y)))(x),                \
                  (__typeof__(__promote(x) + __promote(y)))(y))

inline float __ewl_nexttoward(float x, long double y) {
  return nexttowardf(x, y);
}
inline double __ewl_nexttoward(double x, long double y) {
  return nexttoward(x, y);
}
inline long double __ewl_nexttoward(long double x, long double y) {
...
inline long double __ewl_pow(long double x, long double y) {
  return powl(x, y);
}
#if _EWL_COMPLEX_SUPPORT
inline float complex __ewl_pow(float complex x, float complex y) {
  return cpowf(x, y);
}
inline double complex __ewl_pow(double complex x, double complex y) {
  return cpow(x, y);
}
inline long double complex __ewl_pow(long double complex x,
...
#undef pow
#define pow(x, y)                                                              \
  __ewl_pow((__typeof__(__promote(x) + __promote(y)))(x),                      \
            (__typeof__(__promote(x) + __promote(y)))(y))
...
inline long double __ewl_remainder(long double x, long double y) {
  return remainderl(x, y);
}

#undef remainder
#define remainder(x, y)                                                        \
  __ewl_remainder((__typeof__(__promote(x) + __promote(y)))(x),                \
                  (__typeof__(__promote(x) + __promote(y)))(y))

inline float __ewl_remquo(float x, float y, int *z) { return remquof(x, y, z); }
inline double __ewl_remquo(double x, double y, int *z) {
  return remquo(x, y, z);
}
inline long double __ewl_remquo(long double x, long double y, int *z) {
  return remquol(x, y, z);
}

#undef remquo
#define remquo(x, y, z)                                                        \
  __ewl_remquo((__typeof__(__promote(x) + __promote(y)))(x),                   \
...
inline long double __ewl_scalbln(long double x, long int y) {
  return scalblnl(x, y);
}
...
inline long double complex __ewl_sinh(long double complex x) {
  return csinhl(x);
}
#endif
...
inline long double complex __ewl_sqrt(long double complex x) {
  return csqrtl(x);
}
#endif
...
inline long double complex __ewl_tanh(long double complex x) {
  return ctanhl(x);
}
#endif
...
inline long double complex __ewl_conj(long double complex x) {
  return conjl(x);
}
...
inline long double complex __ewl_cproj(long double complex x) {
  return cprojl(x);
}
...
#if _EWL_COMPLEX_SUPPORT
#define __ewl_is_cplx_flt(expr)                                                \
  (__builtin_types_compatible_p(__typeof__(expr), float complex))
#define __ewl_is_cplx_dbl(expr)                                                \
  (__builtin_types_compatible_p(__typeof__(expr), double complex))
#define __ewl_is_cplx_ldbl(expr)                                               \
  (__builtin_types_compatible_p(__typeof__(expr), long double complex))
#define __ewl_is_cplx(expr)                                                    \
  (__ewl_is_cplx_flt(expr) || __ewl_is_cplx_dbl(expr) ||                       \
   __ewl_is_cplx_ldbl(expr))
#else
...
#define __ewl_select_math(x, y, z, f, d, l)                                    \
  __builtin_choose_expr(                                                       \
      __ewl_is_ldbl(x) || __ewl_is_ldbl(y) || __ewl_is_ldbl(z), l,             \
      __builtin_choose_expr(                                                   \
          __ewl_is_dbl(x) || __ewl_is_dbl(y) || __ewl_is_dbl(z), d, f))

#define __ewl_select_cplx(x, y, z, f, d, l)                                    \
  __builtin_choose_expr(                                                       \
      __ewl_is_cplx_ldbl(x) || __ewl_is_cplx_ldbl(y) || __ewl_is_cplx_ldbl(z), \
      l,                                                                       \
      __builtin_choose_expr(__ewl_is_cplx_dbl(x) || __ewl_is_cplx_dbl(y) ||    \
                                __ewl_is_cplx_dbl(z),                          \
                            d, f))

#define __ewl_math_n_complex(z, M, C)                                          \
  __builtin_choose_expr(__ewl_is_cplx(z),                                      \
                        __ewl_select_cplx(z, 0, 0, C##f(z), (C)(z), C##l(z)),  \
                        __ewl_select_math(z, 0, 0, M##f(z), (R)(z), M##l(z)))

#define __ewl_math_n_complex_2(z1, z2, M, C)                                   \
  __builtin_choose_expr(                                                       \
      __ewl_is_cplx(z1) || __ewl_is_cplx(z2),                                  \
 ...
 *typegeneric macro (for both functions) has the same name as the function in
 *<math.h>. If at least one argument for a generic parameter is complex, then
 *use of the macro invokes a complex function; otherwise, use of the macro
...
#define __ewl_math_2(x, y, M)                                                  \
  __ewl_select_math(x, y, 0, M##f(x, y), (M)(x, y), M##l(x, y))
#define __ewl_math_3(x, y, z, M)                                               \
  __ewl_select_math(x, y, z, M##f(x, y, z), (M)(x, y, z), M##l(x, y, z))
#define __ewl_math_1_2(x, y, M)                                                \
  __ewl_select_math(x, 0, 0, M##f(x, y), (M)(x, y), M##l(x, y))
#define __ewl_math_2_3(x, y, z, M)                                             \
  __ewl_select_math(x, y, 0, M##f(x, y, z), (M)(x, y, z), M##l(x, y, z))
