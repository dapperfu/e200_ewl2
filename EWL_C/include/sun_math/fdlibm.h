...
/* $Id: fdlibm.h,v 1.1.2.1 2013/04/16 11:56:37 rb501c Exp $ */
/*
 * ====================================================
...
extern int32_t _EWL_MATH_CDECL __kernel_rem_pio2f
    __P((const f32_t *, f32_t *, int32_t, int32_t, int32_t, const int32_t *));
...
extern int32_t _EWL_MATH_CDECL __kernel_rem_pio2 __P((const f64_t *, f64_t *,
