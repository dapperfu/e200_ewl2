...
_EWL_BEGIN_EXTERN_C
	...
	/* Use double-precision entry points for long double entry points */
		...
		_EWL_INLINE double _EWL_MATH_CDECL
			lgamma(double x) { int32_t signgamp; return (double)(lgammaf_r)((float)(x), &signgamp); }
	#if _EWL_LONGLONG
	#ifndef __HAS_LLRINT
		_EWL_INLINE long long _EWL_MATH_CDECL
	...
	/* long double entry points */
		...
		_EWL_INLINE long double _EWL_MATH_CDECL
			lgammal(long double x) { int32_t signgamp; return (long double)(lgammaf_r)((float)(x), &signgamp); }
	#if _EWL_LONGLONG
		_EWL_INLINE long long _EWL_MATH_CDECL
