...
_EWL_IMP_EXP_C int _EWL_CDECL wcsicmp(const wchar_t *s1,
                                      const wchar_t *s2) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL wcsnicmp(const wchar_t *s1, const wchar_t *s2,
                                       __std(size_t) n) _EWL_CANT_THROW;
...
_EWL_IMP_EXP_C wchar_t *_EWL_CDECL wcsset(wchar_t *str,
                                          wchar_t wc) _EWL_CANT_THROW;
_EWL_IMP_EXP_C wchar_t *_EWL_CDECL wcsnset(wchar_t *str, wchar_t wc,
                                           __std(size_t) n) _EWL_CANT_THROW;
_EWL_IMP_EXP_C wchar_t *_EWL_CDECL wcsspnp(const wchar_t *s1,
                                           const wchar_t *s2) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL wcsicoll(const wchar_t *,
                                       const wchar_t *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL wcsnicoll(const wchar_t *, const wchar_t *,
                                        __std(size_t)) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL wcsncoll(const wchar_t *, const wchar_t *,
                                       __std(size_t)) _EWL_CANT_THROW;
