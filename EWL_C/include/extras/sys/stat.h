...
/*
 * The following file mode macros are defined to allow compilation of programs
 * that reference them; however, they are not relevant for Windows
 */
...
_EWL_IMP_EXP_C
    _EWL_POSIX_PARAMS _EWL_CDECL umask(_EWL_POSIX_PARAMS) _EWL_CANT_THROW;
#endif
