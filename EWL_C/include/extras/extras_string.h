...
_EWL_IMP_EXP_C int _EWL_CDECL stricmp(const char *,
                                      const char *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL strnicmp(const char *, const char *,
                                       __std(size_t)) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL strcmpi(const char *,
                                      const char *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL strncmpi(const char *, const char *,
                                       __std(size_t)) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL strcasecmp(const char *,
                                         const char *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL strncasecmp(const char *, const char *,
                                          __std(size_t)) _EWL_CANT_THROW;
_EWL_IMP_EXP_C char *_EWL_CDECL strset(char *, int) _EWL_CANT_THROW;
_EWL_IMP_EXP_C char *_EWL_CDECL strnset(char *, int,
                                        __std(size_t)) _EWL_CANT_THROW;
...
_EWL_IMP_EXP_C int _EWL_CDECL stricoll(const char *,
                                       const char *) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL strncoll(const char *, const char *,
                                       __std(size_t)) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL strnicoll(const char *, const char *,
                                        __std(size_t)) _EWL_CANT_THROW;
_EWL_IMP_EXP_C int _EWL_CDECL strerror_r(int, char *,
                                         __std(size_t)) _EWL_CANT_THROW;
_EWL_IMP_EXP_C char *_EWL_CDECL strtok_r(char *_EWL_RESTRICT,
                                         const char *_EWL_RESTRICT,
                                         char **_EWL_RESTRICT) _EWL_CANT_THROW;
