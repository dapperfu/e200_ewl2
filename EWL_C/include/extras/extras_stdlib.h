...
_EWL_IMP_EXP_C char *_EWL_CDECL ultoa(unsigned long, char *,
                                      int) _EWL_CANT_THROW;
...
__inline char *_EWL_CDECL itoa(int val, char *str, int radix) {
  return __ewl_itoa(val, str, radix);
}
__inline char *_EWL_CDECL ltoa(long x, char *y, int z) {
  return (itoa(x, y, z));
}
#else
__inline char *_EWL_CDECL itoa(int val, char *str, int radix) _EWL_CANT_THROW {
