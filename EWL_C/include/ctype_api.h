...
#else
#define _EWL_CMAP_ACCESS                                                       \
  _EWL_LOCALDATA(_current_locale).ctype_cmpt_ptr->ctype_map_ptr
#define _EWL_CLOWER_ACCESS                                                     \
  _EWL_LOCALDATA(_current_locale).ctype_cmpt_ptr->lower_map_ptr
#define _EWL_CUPPER_ACCESS                                                     \
  _EWL_LOCALDATA(_current_locale).ctype_cmpt_ptr->upper_map_ptr
