 ...
 */
_EWL_IMP_EXP_C double complex _EWL_CDECL cpow(double complex x,
                                              double complex y);
_EWL_IMP_EXP_C float complex _EWL_CDECL cpowf(float complex x, float complex y);
_EWL_IMP_EXP_C long double complex _EWL_CDECL cpowl(long double complex x,
...
_EWL_INLINE _EWL_IMP_EXP_C long double _EWL_CDECL
